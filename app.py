from cred import OPENAI_API_KEY, TWILIO_ACCOUNT_SID, TWILIO_AUTH_TOKEN, ASSISTANT_API,TWILIO_FROM_NUMBER,TWILIO_TO_NUMBER,TWILIO_TO_NUMBER2,TWILIO_TO_NUMBER3
import json
